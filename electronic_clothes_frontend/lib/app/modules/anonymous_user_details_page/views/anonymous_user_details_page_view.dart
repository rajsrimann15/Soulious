...
class AnonymousUserDetailsPageView extends GetView<AnonymousUserDetailsPageController> {
  const AnonymousUserDetailsPageView({Key? key}) : super(key: key);
  @override
...
class UserDetailPageFloatingNavbar extends GetWidget<AnonymousUserDetailsPageController> {
...
class UserDetailsHeroSection extends GetWidget<AnonymousUserDetailsPageController> {
...
class _UserDetailsSectionsBreadCrumbState
  ...
  final controller = Get.find<AnonymousUserDetailsPageController>();
...
class UserDetailsBloodAndPhoneSection
    extends GetWidget<AnonymousUserDetailsPageController> {
...
class UserDetailsContactsSection extends GetWidget<AnonymousUserDetailsPageController> {
...
class UserDetailsReportSection extends GetWidget<AnonymousUserDetailsPageController> {
...
class GoogleLoginStyleInputButton extends GetWidget<AnonymousUserDetailsPageController> {
  GoogleLoginStyleInputButton(
      {super.key,
